       ...
       IMPRIMIR-CABECERA.
           ...
           DISPLAY "Cajero Automatico UnizarBank" LINE 02 COL 26
               WITH FOREGROUND-COLOR IS 1.

           MOVE FUNCTION CURRENT-DATE TO CAMPOS-FECHA.

           DISPLAY DIA LINE 04 COL 32.
           DISPLAY "-" LINE 04 COL 34.
           DISPLAY MES LINE 04 COL 35.
           DISPLAY "-" LINE 04 COL 37.
           DISPLAY ANO LINE 04 COL 38.
           DISPLAY HORAS LINE 04 COL 38.
           DISPLAY ":" LINE 04 COL 46.
           DISPLAY MINUTOS LINE 04 COL 47.
       ...
       PLECTURA-ESP.
           DISPLAY "NUM" LINE 09 COL 02.
           DISPLAY "|" LINE 09 COL 06.
           DISPLAY "FECHA" LINE 09 COL 13.
           DISPLAY "|" LINE 09 COL 23.
           DISPLAY "NOMBRE Y DESCRIPCION" LINE 09 COL 34.
           DISPLAY "|" LINE 09 COL 64.
           DISPLAY "LIBRES" LINE 09 COL 65.
           DISPLAY "|" LINE 09 COL 72.
           DISPLAY "IMPORTE" LINE 09 COL 73.

           DISPLAY "Re. pag - Esp. anteriores" LINE 24 COL 02.
       ...
       SALDO-SUFICIENTE.
           ...
           DISPLAY "-" LINE 04 COL 37.
           DISPLAY ANO LINE 04 COL 38.
           DISPLAY HORAS LINE 04 COL 44.
           DISPLAY ":" LINE 04 COL 46.
           DISPLAY MINUTOS LINE 04 COL 47.

           DISPLAY "Compra de entradas de espectaculos" LINE 06 COL 22.
           DISPLAY "Vas a comprar    entradas" LINE 08 COL 15.
           DISPLAY USER-NUM-ENTRADAS LINE 08 COL 29.
           DISPLAY "del espectaculo" LINE 09 COL 15.
           DISPLAY ESP-DESCR LINE 09 COL 31.
       ...
       PANTALLA-RECOGIDA.
           ...
           DISPLAY "Compra de entradas de espectaculos" LINE 06 COL 22.
           DISPLAY "Por favor, retire las entradas" LINE 09 COL 25.
       ...
       NO-ENTR-DISP.
           ...
           DISPLAY "El espectaculo seleccionado no" LINE 09 COL 09
               WITH BACKGROUND-COLOR RED.
           DISPLAY "dispone de suficientes entradas" LINE 09 COL 40
               WITH BACKGROUND-COLOR RED.
           DISPLAY "Enter - Aceptar" LINE 24 COL 33.
       ...
       SALDO-INSUFICIENTE.
           ...
           DISPLAY "Lamentamos comunicarle que" LINE 08 COL 27
               WITH BACKGROUND-COLOR RED.
           DISPLAY "su saldo es insuficiente" LINE 09 COL 28
               WITH BACKGROUND-COLOR RED.
           DISPLAY "Enter - Aceptar" LINE 24 COL 33.
